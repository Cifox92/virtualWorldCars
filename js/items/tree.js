class Tree {
    ...
    draw(ctx, viewPoint) {
        const diff = substract(this.center, viewPoint) //Here we calculate the difference between the center of the view and the tree. This is to calculate then the top of the tree, which changes with the view by moving the map, and make a pseudo 3d image of the tree.
